...
public final class MafiaJobNameResolver {
    private static final Map<String, String> JOB_NAMES = Map.ofEntries(
            ...
            entry("lover", "\uC5F0\uC778"),
            entry("couple", "\uC5F0\uC778"),
            entry("grave_robber", "\uB3C4\uAD74\uAFBC"),
            entry("graverobber", "\uB3C4\uAD74\uAFBC"),
            entry("official", "공무원"),
            entry("official_small", "공무원"),
            entry("official_big", "공무원"),
            entry("cabal", "\uBE44\uBC00\uACB0\uC0AC"),
            entry("cabal_male", "\uBE44\uBC00\uACB0\uC0AC"),
            entry("cabal_female", "\uBE44\uBC00\uACB0\uC0AC"),
            entry("secret_society", "\uBE44\uBC00\uACB0\uC0AC"),
            entry("secret_association", "\uBE44\uBC00\uACB0\uC0AC"),
            entry("hypnotist", "\uCD5C\uBA74\uC220\uC0AC"),
            entry("cultleader", "교주"),
